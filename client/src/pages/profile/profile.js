    ...
    const validateForm = () => {
        ...
        if (registerPassword) {
            if (registerPassword.length < 6) {
                setPasswordError("Le mot de passe doit être au moins de 6 caractères");
                isValid = false;
            ...
            if (registerPassword !== registerPassword2) {
                setPassword2Error("Les mots de passe ne sont pas identiques.");
                isValid = false;
            ...
            axios({
                ...
                .then(response => {
                    if (response.data.message === 'Username already exists') {
                        setErrorMessage('L\'identifiant existe déjà.');
                        setLoading(false);
    ...
    return (
        ...
        <body className=" flex justify-center h-screen mt-11">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg w-96 h-auto">
                ...
                <div>
                    <h1 className="mt-6 text-center text-3xl font-extrabold text-gray-900"> Modifier les données de  {oldUserInfo.username}</h1>
                </div>
                {ErrorMessage && (
