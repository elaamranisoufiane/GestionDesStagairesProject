                        ...
                        <div className="md:p-4 rounded-lg md:flex-auto">
                            <span className="float-left mt-2">
                                <button className="font-bold py-2 px-4 roundedmt-4  items-center  tracking-wide text-white transition duration-200 shadow-md hover:bg-violet-200 focus:shadow-outline focus:outline-none bg-violet-500 rounded"
                                    ...
                                    <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier"  strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z" stroke="#1C274C"  strokeWidth="1.5"></path> <path d="M15 12L12 12M12 12L9 12M12 12L12 9M12 12L12 15" stroke="#1C274C"  strokeWidth="1.5" stroke-linecap="round"></path> </g></svg>
                                </button>
                            </span>
                        ...
                        {users.map((user, index) => (
                            ...
                            >
                                ...
                                <div className="text-sm text-gray-600 space-y-1">
                                    <div>
                                        <span className="font-bold">Nom:</span> {user.lastname}
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <span className="font-bold">privilège: </span>
                                        <span
                                            className={`uppercase ${user.role === 'admin'
                                                ? 'text-green-600'
                                                : user.role === 'user'
                                                    ? 'text-blue-600'
                                                    : 'text-orange-600'
                                    ...
                                    <div>
                                        <span className="font-bold">Utilisateur créé à:</span>{" "}
                                ...
                                <div className="mt-4 flex justify-end space-x-3">
                                    <button
                                        ...
                                        onClick={() => (window.location.href = `/admin/edit/${user.id}`)}
                                    >
                                        <svg
                                            width="24px"
                                            height="24px"
